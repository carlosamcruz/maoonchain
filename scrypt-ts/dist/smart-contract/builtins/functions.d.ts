...
export declare class Utils {
    ...
    /**
     * read a [VarInt (variable integer)]{@link https://learnmeabitcoin.com/technical/varint} field from the beginning of 'buf'
     * @param {ByteString} buf a buffer `ByteString`
     * @returns return a `ByteString` of the VarInt field
     */
    static readVarint(buf: ByteString): ByteString;
    /**
     * convert 'b' to a [VarInt (variable integer)]{@link https://learnmeabitcoin.com/technical/varint} field, including the preceding length
     * @param {ByteString} buf a buffer `ByteString`
     * @returns return a `ByteString` appended the VarInt
     */
