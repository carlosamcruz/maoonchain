...
class FallbackProvider extends abstract_provider_1.Provider {
    ...
    isConnected() {
        return this.configs.findIndex(({ provider }) => {
            return provider.isConnected();
        }) > -1;
    }
    connect() {
        return this.perform("connect", (p) => {
            return p.connect();
        });
    }
    ...
    getFeePerKb() {
        return this.perform("getFeePerKb", (p) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const results = yield Promise.all(this.configs.map(({ provider, weight }) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    //console.log(`perform ${Object.getPrototypeOf(provider).constructor.name}`, method)
                    return Object.assign(normalizeResult({ result: result instanceof abstract_provider_1.Provider ? this : result }), { weight });
                }
                catch (error) {
